                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="role">Document Attachment</label> 
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <label></label>
                                                            <div class="custom-control custom-checkbox mb-3">
                                                                <input id="is_manager" class="custom-control-input" v-model="employee.is_manager" true-value="YES" false-value="NO" type="checkbox">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" v-model="employee.personal_email">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" v-model="employee.phone_number" v-mask="'###-####'" placeholder="XXX-XXXX">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" v-model="employee.mobile_number" v-mask="'09##-###-####'" placeholder="09XX-XXX-XXXX">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" v-model="employee.sss_number" v-mask="'##-#######-#'" placeholder="XX-XXXXXXX-X">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" v-model="employee.hdmf" v-mask="'####-####-####'" placeholder="XXXX-XXXX-XXXX">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" v-model="employee.phil_number" v-mask="'##-#########-#'" placeholder="XX-XXXXXXXXX-X">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" v-model="employee.tax_number" v-mask="'###-###-###-000'" placeholder="XXX-XXX-XXX-000">
    ...
    export default {
        ...
        methods:{
            ...
            storeEmployee(employee){
                ...
                formData.append('is_manager', employee.is_manager ? employee.is_manager : "-");
                ...
                //Contact
                formData.append('personal_email', employee.personal_email ? employee.personal_email : "-");
