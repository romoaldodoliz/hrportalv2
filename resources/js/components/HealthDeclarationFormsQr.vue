            ...
            <div class="container-fluid d-flex align-items-center">
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <h3 class="display-2 text-white text-uppercase">HEALTH DECLARATION FORM</h3>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <button type="button" class="btn btn-primary btn-md mt-2 mb-2" @click="fetchEmployees">Search</button>
                                    </div>
...
<script>
    ...
    export default {
        ...
        created(){
            this.getHDFEmployeeSession();
        },
        methods:{
            getHDFEmployeeSession(){
                axios.get('/fetch-hdf-employee-session')
                .then(response => {
                    if(response.data){
                ...
                .then(response => {
                    ...
                    if(message == 'saved'){
                        ...
                        Swal.fire({
                            ...
                            html: "<h2>"+this.employee.first_name + ' ' + this.employee.last_name+"<h2>" + d,  
                        });
