                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4" v-if="user_access_rights.monthly_basic_salary == 'YES'">
                                                <div class="form-group">
                                                    ...
                                                    <VueNumberFormat v-if="user_access_rights.work_info_edit == 'YES'" class="form-control" v-model="employee_copied.monthly_basic_salary" :options="{ prefix: '', decimal: '.', thousand: ',' }"></VueNumberFormat>
                                                     <input v-else disabled type="number" class="form-control" v-model="employee_copied.monthly_basic_salary">
                                                </div>
                                            </div>
